...
final readonly class CourseStudentResource extends BaseResource
{
    ...
    {
        return $this->request(method: HttpMethod::GET, url: 'course-students', query: $query);
    }
    ...
    {
        return $this->request(method: HttpMethod::GET, url: sprintf('course-students/%s', $id));
    }
}
