...
final readonly class PayoutMethodResource extends BaseResource
{
    ...
    {
        return $this->request(method: HttpMethod::GET, url: 'payout-methods', query: $query);
    }
    ...
    {
        return $this->request(method: HttpMethod::GET, url: sprintf('payout-methods/%s', $id));
    }
}
