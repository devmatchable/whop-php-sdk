...
final readonly class ResolutionCenterResource extends BaseResource
{
    ...
    {
        return $this->request(method: HttpMethod::GET, url: 'resolution-center-cases', query: $query);
    }
    ...
    {
        return $this->request(method: HttpMethod::GET, url: sprintf('resolution-center-cases/%s', $id));
    }
}
