...
final readonly class SetupIntentResource extends BaseResource
{
    ...
    {
        return $this->request(method: HttpMethod::GET, url: 'setup-intents', query: $query);
    }
    ...
    {
        return $this->request(method: HttpMethod::GET, url: sprintf('setup-intents/%s', $id));
    }
}
