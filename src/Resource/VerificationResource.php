...
final readonly class VerificationResource extends BaseResource
{
    ...
    {
        return $this->request(method: HttpMethod::GET, url: 'verifications', query: $query);
    }
    ...
    {
        return $this->request(method: HttpMethod::GET, url: sprintf('verifications/%s', $id));
    }
}
