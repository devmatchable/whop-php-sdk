...
final readonly class RefundResource extends BaseResource
{
    ...
    {
        return $this->request(method: HttpMethod::GET, url: 'refunds', query: $query);
    }
    ...
    {
        return $this->request(method: HttpMethod::GET, url: sprintf('refunds/%s', $id));
    }
}
