...
final readonly class PaymentMethodResource extends BaseResource
{
    ...
    {
        return $this->request(method: HttpMethod::GET, url: 'payment-methods', query: $query);
    }
    ...
    {
        return $this->request(method: HttpMethod::GET, url: sprintf('payment-methods/%s', $id));
    }
}
