...
final readonly class MemberResource extends BaseResource
{
    ...
    {
        return $this->request(method: HttpMethod::GET, url: 'members', query: $query);
    }
    ...
    {
        return $this->request(method: HttpMethod::GET, url: sprintf('members/%s', $id));
    }
}
