...
final readonly class DisputeAlertResource extends BaseResource
{
    ...
    {
        return $this->request(method: HttpMethod::GET, url: 'dispute-alerts', query: $query);
    }
    ...
    {
        return $this->request(method: HttpMethod::GET, url: sprintf('dispute-alerts/%s', $id));
    }
}
