...
final readonly class ReviewResource extends BaseResource
{
    ...
    {
        return $this->request(method: HttpMethod::GET, url: 'reviews', query: $query);
    }
    ...
    {
        return $this->request(method: HttpMethod::GET, url: sprintf('reviews/%s', $id));
    }
}
