...
final class PaymentMethodResourceTest extends TestCase
{
    ...
    private PaymentMethodResource $resource;
    ...
    protected function setUp(): void
    {
        ...
        $this->resource = PaymentMethodResource::initiate(transport: $transport);
    }
    ...
    public function testListPassesQuery(): void
    {
        ...
        self::assertSame('https://api.whop.com/api/v1/payment-methods?page=1', (string) $req->getUri());
        self::assertSame(['data' => []], $result);
    }

    public function testGetFetchesById(): void
    {
        $this->http->willReturn(200, '{"id":"pm_1"}');

        $this->resource->get('pm_1');

        self::assertNotNull($this->http->lastRequest);
        $req = $this->http->lastRequest;
        self::assertSame('GET', $req->getMethod());
        self::assertSame('https://api.whop.com/api/v1/payment-methods/pm_1', (string) $req->getUri());
    }
}
