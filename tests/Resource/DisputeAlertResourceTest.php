...
final class DisputeAlertResourceTest extends TestCase
{
    private RecordingClient $http;
    private DisputeAlertResource $resource;
    ...
    protected function setUp(): void
    {
        ...
        $this->resource = DisputeAlertResource::initiate(transport: $transport);
    }
    ...
    public function testListPassesQuery(): void
    {
        ...
        self::assertSame('https://api.whop.com/api/v1/dispute-alerts?page=1', (string) $req->getUri());
        self::assertSame(['data' => []], $result);
    }

    public function testGetFetchesById(): void
    {
        $this->http->willReturn(200, '{"id":"da_1"}');

        $this->resource->get('da_1');

        self::assertNotNull($this->http->lastRequest);
        $req = $this->http->lastRequest;
        self::assertSame('GET', $req->getMethod());
        self::assertSame('https://api.whop.com/api/v1/dispute-alerts/da_1', (string) $req->getUri());
    }
}
