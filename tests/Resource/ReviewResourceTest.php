...
final class ReviewResourceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->resource = ReviewResource::initiate(transport: $transport);
    }
    ...
    public function testListPassesQuery(): void
    {
        ...
        self::assertSame('https://api.whop.com/api/v1/reviews?page=1', (string) $req->getUri());
        self::assertSame(['data' => []], $result);
    }

    public function testGetFetchesById(): void
    {
        $this->http->willReturn(200, '{"id":"rev_1"}');

        $this->resource->get('rev_1');

        self::assertNotNull($this->http->lastRequest);
        $req = $this->http->lastRequest;
        self::assertSame('GET', $req->getMethod());
        self::assertSame('https://api.whop.com/api/v1/reviews/rev_1', (string) $req->getUri());
    }
}
