...
final class ChatChannelResourceTest extends TestCase
{
    private RecordingClient $http;
    private ChatChannelResource $resource;
    ...
    protected function setUp(): void
    {
        ...
        $this->resource = ChatChannelResource::initiate(transport: $transport);
    }
    ...
    public function testListPassesQuery(): void
    {
        ...
        self::assertSame('https://api.whop.com/api/v1/chat-channels?page=1', (string) $req->getUri());
    ...
    public function testGetFetchesById(): void
    {
        ...
        $req = $this->http->lastRequest;
        self::assertSame('GET', $req->getMethod());
        self::assertSame('https://api.whop.com/api/v1/chat-channels/ch_1', (string) $req->getUri());
    }
    ...
    public function testUpdatePatchesById(): void
    {
        ...
        $this->resource->update('ch_1', ['name' => 'General']);
