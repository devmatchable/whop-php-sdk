...
final class PayoutMethodResourceTest extends TestCase
{
    private RecordingClient $http;
    private PayoutMethodResource $resource;
    ...
    protected function setUp(): void
    {
        ...
        $this->resource = PayoutMethodResource::initiate(transport: $transport);
    }
    ...
    public function testListPassesQuery(): void
    {
        ...
        self::assertSame('https://api.whop.com/api/v1/payout-methods?page=1', (string) $req->getUri());
        self::assertSame(['data' => []], $result);
    }

    public function testGetFetchesById(): void
    {
        $this->http->willReturn(200, '{"id":"pom_1"}');

        $this->resource->get('pom_1');

        self::assertNotNull($this->http->lastRequest);
        $req = $this->http->lastRequest;
        self::assertSame('GET', $req->getMethod());
        self::assertSame('https://api.whop.com/api/v1/payout-methods/pom_1', (string) $req->getUri());
    }
}
